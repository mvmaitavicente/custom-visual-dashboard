...
export class DataService {
    ...
    private static readonly DETAIL_COLUMN_REQUESTS = [
        ...
        { label: "Grado Académico", keywords: ["grado academico", "grado académico", "titulo academico", "título académico", "titulo profesional", "título profesional", "tituloacademico", "tituloprofesional"], role: "tituloProfesional" },

        { label: "Profesión", keywords: ["profesión", "profesion", "profesion locador", "profesional"], role: "profesion" },

        { label: "Posgrado", keywords: ["posgrado", "postgrado", "maestria", "maestría", "doctorado", "maestria doctorado"], role: "maestriaDoctorado" },
